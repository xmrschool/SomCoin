...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x1a9a; // addresses start with "K"
...
const uint32_t UPGRADE_HEIGHT_V6                             = 0; // Block v6
...
const int      RPC_DEFAULT_SSL_PORT                          =  32897;
const int      WALLET_RPC_DEFAULT_PORT                       =  12800;
const int      WALLET_RPC_DEFAULT_SSL_PORT                   =  12900;
const int      GATE_RPC_DEFAULT_PORT                         =  12600;
const int      GATE_RPC_DEFAULT_SSL_PORT                     =  12700;
